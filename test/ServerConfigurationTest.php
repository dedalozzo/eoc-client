...
try {
  ...
  print_r($couch->getConfig());
  print_r($couch->getConfig("admins"));
  print_r($couch->getConfig("couchdb", "database_dir"));
  $couch->setConfigKey("bunga", "minchiazza", "maronna");
  $couch->setConfigKey("bunga", "primula", "troia$%£$%&£DAD''");
  $couch->deleteConfigKey("bunga", "minchiazza");
}
catch (Exception $e) {
  echo ">>> Code: ".$e->getCode()."\r\n";
